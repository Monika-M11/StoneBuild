...
//     },
//     emailId: {},
//     DOB : { required: true, requiredMessage: 'Date of Birth is required' },
...
export default function AddContactScreen() {
  ...
  const { errors, validate } =
    useFormValidation<keyof FormData>({
