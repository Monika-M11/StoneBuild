...
interface ScreenPageProps {
  title: string;
  icon?: string;                    // Icon shown before title (like layers-outline, person-outline, etc.)
  children: React.ReactNode;
  rightAction?: React.ReactNode;
  onMenuPress?: () => void;         // For Profile screen (hamburger menu)
}
      ...
      <View style={styles.container}>
        ...
        <View style={styles.header}>
          ...
          <TouchableOpacity
            ...
            style={styles.leftButton}
          >
            <Ionicons name={leftIconName as any} size={24} color={Colors.light.primaryDark} />
          </TouchableOpacity>

          {/* TITLE + ICON - Perfectly Centered */}
